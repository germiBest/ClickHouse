...
/// Under sanitizer builds, the query profiler uses frame-pointer-based stack unwinding
/// instead of libunwind, which avoids interference with sanitizer internals.
